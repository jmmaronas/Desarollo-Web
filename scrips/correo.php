...
/*Entonces según el formulario que les dejé de ejemplo*/
    ...
    if(isset($_POST['enviar'])){//si el botón con el name enviar es pulsado
        ...
        //guardo el contenido de cada campo en variables
            ...
            $msg="Nombre: ".$nombre."\n".$_POST['consulta'];//el mensaje con el nombre agregado
            ...
            $tuCasilla="jmmaronas@gmail.com";//tenés que colocar tu casilla de email de consultas,es decir, la casilla en la cual vas a recibir las consultas que deja la gente en tu página
